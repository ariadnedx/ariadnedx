...
the use of two molecularly targeted agents, Erbitux™ and Vectibix™.  Both of these FDA-approved drugs are targeted at the epidermal 
...
mCRC pateint response to anti-EFGR drugs (mCRC-strat™) based on a panel of biomarkers. This test uses a proprietary series of biomarkers 
first identified using the Company’s unique integrated bioinformatics approach. The mCRC-strat™ test will consist of panel of no more than 

10 predictive biomarkers from the fifteen promising candidates. The mCRC-strat™ is a novel predictive test for mCRC (WT KRAS) patient 
...
significantly reduce the number of unnecessary and ineffective anti-EGFR treatments. Thus, the mCRC-strat™ test will enhance the efficiency 
...
used to select suitable patients for treatment with anti-EGFR therapies, based on the patient’s biomarker status. The mCRC-strat™ patient’s 
...
<h2>Neuromuscular and neurodegenerative disease</h2>
...
<h2>Biomarkers Discovery for Rare NMD and NDD</h2>
